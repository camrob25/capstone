...
const cars = [
  ...
  },
  {
    ...
    zeroToSixty: 8.5,
    seats: 5,
    reservUrl: "https://www.enterprise.com/en/reserve.html#review",
  },
  {
    title: "Luxury",
    category: "Luxury",
    price: 149,
    description: "Audi A3 or similar",
  ...
  },
  {
    ...
    seats: 4,
    reserveUrl:
      "https://www.hertz.com/us/en/book/ancillaries/coverage?CDP=2278478&age=25&ddate=2025-02-05T12%3A00%3A00&did=SHVT11&pCountryCode=US&pdate=2025-02-04T12%3A00%3A00&pid=SHVT11&rateQuoteIds=VCPD1%7C75D4HBIG1072089-41%7C9,RCUD1%7C75D4HBIG1072089-41%7C10&sippCode=FCAR&travelType=LEISURE",
  },
  {
    title: "Full-size",
    category: "Full-size",
  ...
  },
  {
    ...
    seats: 4,
    reserveUrl:
      "https://www.hertz.com/us/en/book/ancillaries/coverage?CDP=2278478&age=25&ddate=2025-02-05T12%3A00%3A00&did=SHVT11&pCountryCode=US&pdate=2025-02-04T12%3A00%3A00&pid=SHVT11&rateQuoteIds=VCPD1%7CFP6LHIE20472110-41%7C14,RCUD1%7CFP6LHIE20472110-41%7C13&sippCode=IFAR&travelType=LEISURE",
  },
  {
    title: " Full-Size SUV",
    category: "Full-Size SUV",
    price: 126.8,
    description: "Chevrolet Tahoe or similar",
...
const FindMyCar = () => {
  ...
  const findCar = () => {
    let results = cars.filter((car) => {
      if (purpose === "Moving" && car.category.toLowerCase().includes("trucks"))
        return true;
      if (budget === "economy" && car.category === "Economy") return true;
      if (budget === "mid" && car.category === "Mid-size") return true;
      if (budget === "luxury" && car.category.toLowerCase().includes("luxury"))
        return true;
      if (
        groupSize === "5+" &&
        (car.category.includes("SUV") || car.category.includes("Full-size"))
      )
        return true;
      return false;
    });
